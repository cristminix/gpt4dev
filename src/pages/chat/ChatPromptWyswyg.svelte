    ...
    const editor = new Editor({
      ...
      extensions: [
        StarterKit.configure({
          ...
          bulletList: {
            HTMLAttributes: {
              class: "list-disc ml-4 text-gray-800 dark:text-white",
            },
          },
          orderedList: {
            HTMLAttributes: {
              class: "list-decimal ml-4 text-gray-800 dark:text-white",
            },
          },
          listItem: {
            HTMLAttributes: {
    ...
    const actions = [
      {
        ...
        fn: () => editor.chain().focus().toggleMark("bold").run(),
      },
      {
        id: "#hs-editor-tiptap-blockquote-alt [data-hs-editor-italic]",
        fn: () => editor.chain().focus().toggleMark("italic").run(),
      },
      {
        id: "#hs-editor-tiptap-blockquote-alt [data-hs-editor-underline]",
        fn: () => editor.chain().focus().toggleMark("underline").run(),
      },
      {
        id: "#hs-editor-tiptap-blockquote-alt [data-hs-editor-strike]",
        fn: () => editor.chain().focus().toggleMark("strike").run(),
      },
      {
      ...
      },
      {
        ...
        fn: () => editor.chain().focus().toggleMark("code").run(),
      },
    ]

    actions.forEach(({ id, fn }) => {
      const action = document.querySelector(id) as HTMLElement | null
...
<div class="max-w-6xl mx-auto sticky bottom-0 z-10 p-3 sm:py-6">
  ...
  >
    <div id="hs-editor-tiptap-blockquote-alt">
      <div
        class="sticky hidden top-0 bg-white flex align-middle gap-x-0.5 border-b border-gray-200 p-2 dark:bg-neutral-900 dark:border-neutral-700"
      >
        <button
