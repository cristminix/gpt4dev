...
const handle_ask = async (do_ask_gpt = true, message = null) => {
    ...
    */
    ...
    message_el.innerHTML = `
        <li class="py-2 sm:py-4 user text-gray-800 dark:text-white">
...
const load_conversation = async (conversation) => {
    ...
    messages.forEach((item, i) => {
        ...
        add_buttons.push(`<button class="options_button hidden">
            <div>
        ...
        if (actions.includes("variant")) {
            add_buttons.push(`<button class="regenerate_button hidden">
